...
- [ ] T026 [US2] **Requires the user** — exercise a conversational plan modification end to end through the coach in real Telegram, since this is the one reader (`plan_modifier.py`, LLM-driven) whose output tests cannot fully predict (FR-012). Not yet done; ask the user when the app is next running
