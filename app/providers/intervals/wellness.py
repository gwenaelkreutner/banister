    ...
    *,
    ...
    for record in records:
        await wellness_repo.upsert(
            ...
            hrv_sdnn=record.get("hrvSDNN"),
            sleep_quality=record.get("sleepQuality"),
            sleep_score=record.get("sleepScore"),
            mental_energy=record.get("mentalEnergy"),
            avg_sleeping_hr=record.get("avgSleepingHR"),
            vo2max=record.get("vo2max"),
            fatigue=record.get("fatigue"),
            soreness=record.get("soreness"),
            ...
            blood_glucose=record.get("bloodGlucose"),
            systolic=record.get("systolic"),
            diastolic=record.get("diastolic"),
            baevsky_si=record.get("baevskySI"),
            lactate=record.get("lactate"),
            respiration=record.get("respiration"),
            body_fat_pct=record.get("bodyFat"),
            abdomen_cm=record.get("abdomen"),
            steps=record.get("steps"),
            hydration_volume_l=record.get("hydrationVolume"),
            kcal_consumed=record.get("kcalConsumed"),
            carbohydrates_g=record.get("carbohydrates"),
            protein_g=record.get("protein"),
            fat_g=record.get("fatTotal"),
            menstrual_phase=record.get("menstrualPhase"),
            menstrual_phase_predicted=record.get("menstrualPhasePredicted"),
