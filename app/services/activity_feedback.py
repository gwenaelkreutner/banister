    ...
    *,
    ...
    if match_result.candidate is None or not match_result.is_aligned:
        ...
        log_unplanned = await repo.session_log_repo.create(
            ...
            elevation_gain_m=initial_analyzed.elevation_gain_m,
            average_temp_c=initial_analyzed.average_temp_c,
            kilojoules=initial_analyzed.kilojoules,
    ...
    log = await repo.session_log_repo.create(
        ...
        average_temp_c=analyzed.average_temp_c,
        kilojoules=analyzed.kilojoules,
